...
PopupMenu unauthMenu = PopupMenu(
    items: [
      MenuItem(title: "Sign Up", textStyle: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
      MenuItem(title: 'Sign In', textStyle: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
    ],
